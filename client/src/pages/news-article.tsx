      ...
      galleryImages: [
        {
          ...
          altAr: 'شعار شركة مكامن السعودية القابضة'
        }
      ],
      content: {
        lead: 'شركة مكامن السعودية القابضة لخدمات النفط والغاز (شركة مساهمة مقفلة – السجل التجاري رقم: 1010251168) تدعو جميع المساهمين لحضور الجمعية العمومية غير العادية.',
        leadAr: 'شركة مكامن السعودية القابضة لخدمات النفط والغاز (شركة مساهمة مقفلة – السجل التجاري رقم: 1010251168) تدعو جميع المساهمين لحضور الجمعية العمومية غير العادية.',
        
        body: [
          {
            title: 'تفاصيل الاجتماع',
            titleAr: 'تفاصيل الاجتماع',
            content: '📍 المكان: مقر الشركة– مدينة الرياض وكذلك مرئي لمن لا يستطيع عبر الرابط المرسل\n📅 موعد الانعقاد: يوم الثلاثاء 22 يوليو 2025م\n🕚 الوقت: الساعة 11:00 صباحًا\n⏱️ الاجتماع الثاني: الساعة 12:00 ظهرًا (في حال عدم اكتمال النصاب في الاجتماع الأول)\n📌 رابط المنصة الإلكترونية: يُرسل عبر البريد الإلكتروني يوم 21 يوليو 2025م',
            contentAr: '📍 المكان: مقر الشركة– مدينة الرياض وكذلك مرئي لمن لا يستطيع عبر الرابط المرسل\n📅 موعد الانعقاد: يوم الثلاثاء 22 يوليو 2025م\n🕚 الوقت: الساعة 11:00 صباحًا\n⏱️ الاجتماع الثاني: الساعة 12:00 ظهرًا (في حال عدم اكتمال النصاب في الاجتماع الأول)\n📌 رابط المنصة الإلكترونية: يُرسل عبر البريد الإلكتروني يوم 21 يوليو 2025م'
          },
          {
            title: 'لماذا هذه الجمعية بالغة الأهمية؟',
            titleAr: 'لماذا هذه الجمعية بالغة الأهمية؟',
            content: 'لأنها ليست إجراءً روتينيًا، بل مفترق طرق يُحدد مستقبل الشركة.\nصوتك هذه المرة ليس حضورًا فقط، بل قرارًا سياديًا.',
            contentAr: 'لأنها ليست إجراءً روتينيًا، بل مفترق طرق يُحدد مستقبل الشركة.\nصوتك هذه المرة ليس حضورًا فقط، بل قرارًا سياديًا.'
          },
          {
